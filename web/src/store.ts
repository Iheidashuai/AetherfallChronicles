...
type Screen = 'auth' | 'create-player' | 'home' | 'character' | 'inventory' | 'item-catalog' | 'skills' | 'blacksmith' | 'quests' | 'market' | 'shop' | 'builds' | 'endgame' | 'arena' | 'guild' | 'chat' | 'leaderboard' | 'robots' | 'recharge' | 'dungeons' | 'result';

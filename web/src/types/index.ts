...
export type MarketCategoryFilter = 'all' | 'equipment' | 'gem' | 'material' | 'consumable' | 'chest' | 'sweepTicket';
...
export type ShopCategoryFilter = 'all' | 'sweep' | 'gold' | 'stamina' | 'enhancement' | 'gem' | 'growth' | 'chest';
